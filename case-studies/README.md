# Case Studies — Focus & Execution Harness v3.1
...
| 03 | [Client Onboarding](03-client-onboarding/) | Scenario brief | Memory Pipeline | Your project is repeatable across clients/accounts and benefits from knowledge compounding |
...
The Marketing Funnel Launch (01) includes complete file artifacts — config, PROJECT.md, TASK-STATE.yaml, reference rules, and task files. All other case studies are scenario briefs: a single markdown file that maps the domain to the five mechanisms with example values. The briefs reference the full example for file format patterns.
