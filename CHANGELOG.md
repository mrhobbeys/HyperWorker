...
- **Field-evidence features** — *landing.* Two of six landed (see §Landed — field evidence above): evidence capture and exclusion discipline. Still to come: the slim friction log, `operator.correction`, open-loop tracking, and `read_only_pass`.
