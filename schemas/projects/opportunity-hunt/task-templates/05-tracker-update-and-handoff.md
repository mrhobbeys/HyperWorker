...
depends_on: [T-004]
acceptance_criteria:
  - "This channel's tab in the shared tracker is updated with current statuses + new finds."
...
1. Update this channel's tab in the tracker at OR-001 deliverable_path.
...
3. Report status up to the orchestrator/parent program, if this channel runs under one.
