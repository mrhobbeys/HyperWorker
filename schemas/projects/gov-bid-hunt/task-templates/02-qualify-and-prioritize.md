...
acceptance_criteria:
  ...
  - "Each pursuing Finding is eligibility-checked against OR-001 (biddable now, or teaming/sub, or blocked)."
  - "Findings are ranked: eligibility > fit > deadline proximity > effort."
---
...
3. Flag any that need teaming/subcontracting (set-asides we don't hold; capability gaps → the OR-001 subcontracting partner).
